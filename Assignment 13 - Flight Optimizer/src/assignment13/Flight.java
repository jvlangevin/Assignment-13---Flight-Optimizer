...
/**
 * This class defines what is a flight, what it contains and what it does. A flight is a path between two airports, an
 * origin and a destination. Each flight has differing flight criteria: carriers, time delay, previous cancellations,
...
public class Flight {
	 ...
	 * 
	 * @param origin
	 *            - the airport traveling from
	 * @param destination
	 *            - the airport traveling to
	 * @param carrier
	 *            - the company who owns the plane
	 * @param delay
	 *            - the delay of departure
	 * @param canceled
	 *            - where this flight had previously been cancelled
	 * @param time
	 *            - the time the flight takes
	 * @param distance
	 *            - the distance the flight travels.
	 * @param cost
	 *            - the cost in $'s
	 */
	...
	/**
	 * 
	 * @return the origin airport's symbol +,+ the destination airport's symbols Used as a key for flight hashmap in
	 *         NetworkGraph
	 */
	...
	/**
	 * Takes the numerical values associated with the flight (delay, time distance, cost, canceled, numFlights) and
	 * divides by the number of flights we've found with similar flight paths and updates the flight it's called it
	 * with the new values.
	 */
	 ...
	 * 
	 * @param attr
	 *            - a flight attribute that will serve as the weight value for this flight
	 */
